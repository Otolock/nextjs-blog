...
export const metadata = {
  ...
  description: 'Embark on a journey with Antonio Santos, a software developer and aspiring tech entrepreneur. Discover a mix of in-depth articles on software design, startup insights, and the adventures of building in the tech world.',
}
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-neutral-600 dark:text-neutral-400">
            I’m Antonio, a software developer and aspiring founder based in Puerto Rico.
          </p>
